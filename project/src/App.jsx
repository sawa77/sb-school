...
class App extends React.Component {
    ...
    onEdit(isNew) {
        let editingRow = {}
        if (!isNew) {
            editingRow = this.state.selectedRow
        }
        this.setState({editingRow, orderCardOpened: true, isNew})
    }
    ...
    render() {
        ...
        return (
            <div className={cc({
                ...
                />
                <input type='button' value='Добавить...' onClick={() => this.onEdit(true)}/>
                <input type='button' value='Изменить...' onClick={() => this.onEdit(false)}/>
                {
